...
$app->post('/api/FreshbooksAPI/getGateways', function ($request, $response, $args) {
    ...
    $query_str = 'https://api.freshbooks.com/accounting/account/'.$post_data['args']['accountId'].'/system/gateways';
