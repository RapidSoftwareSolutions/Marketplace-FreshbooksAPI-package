...
$app->post('/api/FreshbooksAPI/getAllExpenseCategories', function ($request, $response, $args) {
    ...
    $query_str = 'https://api.freshbooks.com/accounting/account/'.$post_data['args']['accountId'].'/expenses/categories';
