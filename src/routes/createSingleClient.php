...
$app->post('/api/FreshbooksAPI/createSingleClient', function ($request, $response, $args) {
    ...
    $query_str = 'https://api.freshbooks.com/accounting/account/'.$post_data['args']['accountId'].'/users/clients';
