...
$app->post('/api/FreshbooksAPI/getStaffs', function ($request, $response, $args) {
    ...
    $query_str = 'https://api.freshbooks.com/accounting/account/'.$post_data['args']['accountId'].'/users/staffs';
